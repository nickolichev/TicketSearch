...
public class RepositoryTicketsTest {
  ...
  void findByAirportsDeparture() {
    ...
    Ticket[] expected = {Aeroflot, BritishAirways, WizzAir, Iberia, Finnair, JetBlue, Emirates};
  ...
  void findByAirportsArrival() {
    ...
    Ticket[] expected = {Aeroflot, BritishAirways, WizzAir, Lufthansa, KLM, JetBlue, Emirates};
    assertArrayEquals(expected, actual);
  }
